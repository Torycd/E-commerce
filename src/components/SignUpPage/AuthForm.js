...
const { createUser} = UserAuth
  ...
  const nameInputClasses = nameInputHasError
    ? "mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 invalid"
    : "mt-8 mb-2 w-80 max-w-screen-lg sm:w-96";
  return (
    <div
      className="relative flex flex-col bg-transparent bg-clip-border text-gray-700 items-center
    justify-center bg-white shadow-md rounded-3xl px-8 pt-6 pb-8 mb-4"
    >
